...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_3.addWidget(self.txt_Calibration_Y2, 1, 3, 1, 1)
        self.groupBox = QtWidgets.QGroupBox(self.tab_calibration)
        ...
        self.txt_scale = QtWidgets.QLabel(self.groupBox)
        ...
        self.radioButton_Log.setEnabled(False)
        ...
        self.radioButton_Linear = QtWidgets.QRadioButton(self.groupBox)
        self.radioButton_Linear.setEnabled(False)
        ...
        self.txt_LowerBound = QtWidgets.QLabel(self.groupBox)
        self.txt_LowerBound.setObjectName("txt_LowerBound")
        self.horizontalLayout_2.addWidget(self.txt_LowerBound)
        self.UserInput_LowerBound = QtWidgets.QLineEdit(self.groupBox)
        self.UserInput_LowerBound.setObjectName("UserInput_LowerBound")
        self.horizontalLayout_2.addWidget(self.UserInput_LowerBound)
        self.txt_UpperBound = QtWidgets.QLabel(self.groupBox)
        self.txt_UpperBound.setObjectName("txt_UpperBound")
        self.horizontalLayout_2.addWidget(self.txt_UpperBound)
        self.UserInput_UpperBound = QtWidgets.QLineEdit(self.groupBox)
        self.UserInput_UpperBound.setObjectName("UserInput_UpperBound")
        self.horizontalLayout_2.addWidget(self.UserInput_UpperBound)
        self.verticalLayout_2.addLayout(self.horizontalLayout_2)
        self.gridLayout_3.addWidget(self.groupBox, 7, 0, 1, 5)
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.Button_Calibration = QtWidgets.QPushButton(self.tab_calibration)
        self.Button_Calibration.setObjectName("Button_Calibration")
        self.horizontalLayout_3.addWidget(self.Button_Calibration)
        spacerItem = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_3.addItem(spacerItem)
        self.gridLayout_3.addLayout(self.horizontalLayout_3, 8, 0, 1, 5)
        self.UserInput_Calibration_Y1 = QtWidgets.QLineEdit(self.tab_calibration)
        self.UserInput_Calibration_Y1.setEnabled(False)
        self.UserInput_Calibration_Y1.setObjectName("UserInput_Calibration_Y1")
        self.gridLayout_3.addWidget(self.UserInput_Calibration_Y1, 0, 4, 1, 1)
        self.UserInput_Calibration_X2 = QtWidgets.QLineEdit(self.tab_calibration)
        self.UserInput_Calibration_X2.setEnabled(False)
        self.UserInput_Calibration_X2.setObjectName("UserInput_Calibration_X2")
        self.gridLayout_3.addWidget(self.UserInput_Calibration_X2, 1, 2, 1, 1)
        self.txt_Calibration_Y1 = QtWidgets.QLabel(self.tab_calibration)
        self.txt_Calibration_Y1.setObjectName("txt_Calibration_Y1")
        self.gridLayout_3.addWidget(self.txt_Calibration_Y1, 0, 3, 1, 1)
        self.txt_Calibration_X2 = QtWidgets.QLabel(self.tab_calibration)
        self.txt_Calibration_X2.setObjectName("txt_Calibration_X2")
        self.gridLayout_3.addWidget(self.txt_Calibration_X2, 1, 0, 1, 1)
        ...
        self.History_List = QtWidgets.QListWidget(self.tab_History)
        ...
        self.menuImages.addAction(self.actionCalibrate)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox.setTitle(_translate("MainWindow", "Scale Options"))
        ...
        self.txt_LowerBound.setText(_translate("MainWindow", "Lower Bound:"))
        self.txt_UpperBound.setText(_translate("MainWindow", "Upper Bound:"))
        self.Button_Calibration.setText(_translate("MainWindow", "Calibrate Image"))
